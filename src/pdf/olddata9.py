...
Y_train = np_utils.to_categorical(Y_train, nb_classes)  # np_utils 사용
Y_test = np_utils.to_categorical(Y_test, nb_classes)  # np_utils 사용
...
plt.figure()
plt.plot(history.history["val_acc"])  # val_accuracy -> val_acc
plt.plot(history.history["acc"])  # accuracy -> acc
